...
fan1 = Fan.create(name: "Lil Penny", location: "Memphis, TN", age: 18, photo:"https://s-media-cache-ak0.pinimg.com/originals/5e/63/9b/5e639b95356af81f88fbe4c9ff1235c6.jpg", email: "email@email.com", password: "password")
fan2 = Fan.create(name: "Michael Jordan", location: "Chicago, IL", age: 54, photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/b/b3/Jordan_Lipofsky.jpg/170px-Jordan_Lipofsky.jpg", email: "email@email.com", password: "password")
fan3 = Fan.create(name: "Mark Parker", location: "Poughkeepsie, NY", age: 61, photo:"http://www.azquotes.com/public/pictures/authors/b8/6a/b86aed5f80ae2133c0a151f691e3c823/549dfb7926d53_mark_parker.jpg", email: "email@email.com", password: "password")
fan4 = Fan.create(name: "Will Kicks", location: "Newark, NE", age: 21, photo:"http://images.complex.com/complex/image/upload/t_article_image/sneakerheadz-documentary-trailer-01_uzcobs.jpg", email: "email@email.com", password: "password")
fan5 = Fan.create(name: "Rodney Stereo", location: "Trenton, NJ", age: 25, photo:"http://reactiongifs.me/wp-content/uploads/2014/03/the-ultimate-warrior-head-shaking-gif-james-brian.gif", email: "email@email.com", password: "password")
